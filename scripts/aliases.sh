...
alias bsputd="pushd $SPUTTER_ROOT &> /dev/null; ./scripts/build_linux.sh --debug; popd &> /dev/null"
...
alias egamed="pushd $SPUTTER_ROOT > /dev/null; ./build-debug/src/exe/paddlearena/paddlearena $PADDLE_ARENA_ASSETS_ROOT; popd > /dev/null"
alias egamedcli="pushd $SPUTTER_ROOT > /dev/null; ./build-debug/src/exe/paddlearena/paddlearena $PADDLE_ARENA_ASSETS_ROOT --p2p-client $1 --log-verbosity $SPUTTER_VERBOSITY; popd > /dev/null"
# Server
alias egamesrv="pushd $SPUTTER_ROOT > /dev/null; ./build/src/exe/paddleserver/paddleserver; popd > /dev/null"
alias egamedsrv="pushd $SPUTTER_ROOT > /dev/null; ./build-debug/src/exe/paddleserver/paddleserver; popd > /dev/null"
